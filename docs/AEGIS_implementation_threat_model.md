...
| Weighted fair queues (WFQ) | research/ops | **Partial/Mitigated (2026-07-17)** — per-connection inbound queues + weighted credit RR from peer-health success rate (default weight 1); outbound still shared; not continuous GPS/WFQ |
