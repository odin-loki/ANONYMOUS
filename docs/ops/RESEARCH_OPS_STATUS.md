...
**Date:** 2026-07-17  
**Wave:** Partial-closeout (snow Noise, outbound WFQ, AC issuer, WSL dudect)  
...
| 7 | ZK anonymous reputation | **Partial** | Presentation + `NullifierRegistry` + `AnonymousCredentialIssuer` | **External:** interactive AC / real ZK show |
...
| 10 | dudect / CT evidence | **Partial** | In-tree smoke + `scripts/run_dudect_wsl.sh` + ops doc | **External:** oreparaz/dudect C harness + isolated CPU lab |
...
See README and the plan completion log.
